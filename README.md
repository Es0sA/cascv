...
- [x] Real pagination (single-column, two-column, and the 5 sidebar
      templates all split correctly across PDF pages; Mix layout is the
      one deliberate exception, still on the older flowing pagination)
